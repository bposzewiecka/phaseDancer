...
You can try PhaseDancer assembler and accompaying [PhaseDancerViewer](https://github.com/bposzewiecka/phaseDancerViewer) application on the example data generated by the [PhaseDancerSimulator](https://github.com/bposzewiecka/phaseDancerSimulaator) of segmental duplications using docker container. 
...
Download script [example.sh](example.sh) and run it using the following command:
